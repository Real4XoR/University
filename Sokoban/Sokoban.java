...
public class Sokoban {
    ...
    private Stack <ActionRecord> history = new Stack <ActionRecord>(); //Stack to keep track of all previous moves
    ...
    public void undo() {
        if (history.isEmpty()) {
            String undoDirection = opposite(history.pop().direction());
            pull(undoDirection);
        }
    }
