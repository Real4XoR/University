...
public abstract class AbstractCardGame implements CardGame {
	...
	public CardGame clone() {
		...
		/**
		 * I have no idea how to do a deep clone without serialization and didn't read the prompt that said
		 * not too it until I wrote this method up lmao
		 */
		try {
			...
			CardGame cg = (CardGame) in.readObject();
			return cg;
		}catch(Exception e) {
