...
public class Pawn extends PieceImpl implements Piece {
	...
	public boolean isValidMove(Position oldPosition, Position newPosition,
		...
		} else if ((oldRow + direction) == newRow && oldCol == newCol) {
			return this.equals(p) && t == null;
		} else if ((oldRow + direction + direction) == newRow && oldCol == newCol) {
			return ((direction == 1 && oldRow == 2)
					|| (direction == -1 && oldRow == 7))
					&& board.pieceAt(new Position(oldRow + direction, oldCol)) == null
