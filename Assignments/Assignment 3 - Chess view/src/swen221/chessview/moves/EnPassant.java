...
public class EnPassant extends SinglePieceTake {
	...
	public boolean isValid(Board board) {
		...
		Position takePos = getTakenPosition();
		Piece takenPce = board.pieceAt(takePos);
		if (!(takenPce instanceof Pawn)) {
			return false;
		}

		return checkValidPieceTaken(board) && checkValidPositions() && ((Pawn) takenPce).wasDoubleStep();
	}
