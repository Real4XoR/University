...
public class Permutations {
    ...
    public void extendPermutation(Set<String> remainingItems, Stack<String> permutationSoFar, List<List<String>> allPermutations){
        Set<String> tempSet = new HashSet<String>(remainingItems);
        
        if (counter > 10000) { //only going through the first 10,000 permutations
            return;
        }
        else {
            ...
            for (String item : remainingItems) {
                ...
                extendPermutation(tempSet, permutationSoFar, allPermutations);
