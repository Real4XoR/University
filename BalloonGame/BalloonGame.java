...
public class BalloonGame {
    ...
    public void restartGame(){
        UI.clearPanes();
        UI.setFontSize(14);
        UI.drawString("Score: " + score, 10, 580);
        for (int i = 0; i <= MAX_BALLOONS; i++) {
            Balloon balloon = new Balloon(50 + Math.random() * 400, 50 + Math.random() * 400);
    ...
    public void lockScore() {
        UI.printMessage("Final score was: " + score);
    }
