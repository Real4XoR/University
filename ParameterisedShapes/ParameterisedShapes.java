...
public class ParameterisedShapes{
    ...
    public void drawThreeStripeFlag(double left, double top, boolean horiz, Color stripe1, Color stripe2, Color stripe3) {
        if (horiz == true) { //if horiz is true it draws them horizontally else it draws them vertically
            UI.setColor(stripe1);
            UI.fillRect(left, top, FLAG_WIDTH, FLAG_HEIGHT);
            UI.setColor(stripe2);
            UI.fillRect(left, top, FLAG_WIDTH, FLAG_HEIGHT*2/3);
            UI.setColor(stripe3);
            ...
            UI.fillRect(left, top, FLAG_WIDTH, FLAG_HEIGHT);
            UI.setColor(stripe2);
            UI.fillRect(left, top, FLAG_WIDTH*2/3, FLAG_HEIGHT);
            UI.setColor(stripe3);
