...
public class BattleGame{
    ...
    public void restart(){
        ...
        tableComputer = new ArrayList<Card>();
        tablePlayer = new ArrayList<Card>();
        Card[] hand = new Card[NUM_HAND];
    ...
    public void drawHandCards(){
        for (int i = 0; i<NUM_HAND; i++) {
            if (hand[i] != null) {
                hand[i].draw(HAND_LEFT+i*CARD_SPACING, 100);
            }
        }
    ...
    public void playBattle(){
        for (int i = 0; i<NUM_HAND; i++) {
            if (hand[0] != null && this.tableComputer.get(i) != null) {
                hand[0] = this.tablePlayer.get(0);
                this.tableComputer.add(deck.get(0));
            }
        }
